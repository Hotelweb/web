...
- [ ] 1. Backend Setup and Database Configuration
  - [ ] 1.1 Install backend dependencies and configure Prisma
  ...
  - [ ] 1.2 Create Prisma schema with Admin, Location, and Message models
  ...
  - [ ] 1.3 Create PrismaModule and PrismaService
...
- [ ] 2. Authentication Module
  ...
  - [ ] 2.2 Implement AuthService with login and validation
  ...
  - [ ] 2.3 Implement AuthController with login endpoint
    - Create `POST /api/auth/login` endpoint
    - Return 401 Unauthorized for invalid credentials
    - Return JWT token and admin details on success
    - _Requirements: 3.1, 3.2_

  - [ ] 2.4 Create JwtAuthGuard and CurrentAdmin decorator
  ...
  - [ ]\* 2.5 Write property test for authentication token generation
    - **Property 5: Authentication Token Generation**
    - **Validates: Requirements 3.1, 3.4**

  - [ ]\* 2.6 Write property test for authentication failure security
    - **Property 6: Authentication Failure Security**
    - **Validates: Requirements 3.2, 3.5**

  - [ ]\* 2.7 Write property test for password hash security
    - **Property 7: Password Hash Security**
    - **Validates: Requirement 3.6**

- [ ] 3. Checkpoint - Backend Auth Setup
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 4. Locations Module
  - [ ] 4.1 Create Locations module structure with DTOs
  ...
  - [ ] 4.2 Implement LocationsService with CRUD operations
  ...
  - [ ] 4.3 Implement LocationsService admin dashboard methods
  ...
  - [ ] 4.4 Implement LocationsController with REST endpoints
  ...
  - [ ]\* 4.5 Write property test for slug uniqueness and URL-safety
    - **Property 1: Slug Uniqueness and URL-Safety**
    - **Validates: Requirements 1.4, 1.5, 5.1, 5.5**

  - [ ]\* 4.6 Write property test for location resolution correctness
    - **Property 2: Location Resolution Correctness**
    - **Validates: Requirements 1.1, 1.2**

  - [ ]\* 4.7 Write property test for location name validation
    - **Property 12: Location Name Validation**
    - **Validates: Requirement 5.4**

  - [ ]\* 4.8 Write property test for cascade delete integrity
    - **Property 11: Cascade Delete Integrity**
    - **Validates: Requirements 5.3, 7.4**

- [ ] 5. Messages Module
  - [ ] 5.1 Create Messages module structure with DTOs
  ...
  - [ ] 5.2 Implement MessagesService with persistence and retrieval
  ...
  - [ ] 5.3 Implement MessagesController with REST endpoints
  ...
  - [ ]\* 5.4 Write property test for message persistence guarantee
    - **Property 13: Message Persistence Guarantee**
    - **Validates: Requirements 6.1, 7.1**

  - [ ]\* 5.5 Write property test for read status by sender type
    - **Property 15: Read Status by Sender Type**
    - **Validates: Requirements 6.3, 12.1**

  - [ ]\* 5.6 Write property test for message content validation
    - **Property 18: Message Content Validation**
    - **Validates: Requirement 7.5**

  - [ ]\* 5.7 Write property test for pagination correctness
    - **Property 17: Pagination Correctness**
    - **Validates: Requirement 7.3**

  - [ ]\* 5.8 Write property test for message ordering consistency
    - **Property 16: Message Ordering Consistency**
    - **Validates: Requirements 6.6, 7.2**

- [ ] 6. Checkpoint - Backend CRUD Operations
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 7. WebSocket Gateway (Chat Module)
  - [ ] 7.1 Create Chat module structure with DTOs
  ...
  - [ ] 7.2 Implement ChatGateway connection management
  ...
  - [ ] 7.3 Implement ChatGateway room operations
  ...
  - [ ] 7.4 Implement ChatGateway message handling
  ...
  - [ ] 7.5 Implement ChatGateway typing indicators
  ...
  - [ ]\* 7.6 Write property test for message history limit
    - **Property 3: Message History Limit**
    - **Validates: Requirement 2.4**

  - [ ]\* 7.7 Write property test for sender type validation
    - **Property 4: Sender Type Validation**
    - **Validates: Requirement 2.9**

  - [ ]\* 7.8 Write property test for room isolation
    - **Property 14: Room Isolation**
    - **Validates: Requirements 6.2, 6.5**

  - [ ]\* 7.9 Write property test for client cleanup on disconnect
    - **Property 19: Client Cleanup on Disconnect**
    - **Validates: Requirement 9.3**

  - [ ]\* 7.10 Write property test for location not found error
    - **Property 22: Location Not Found Error**
    - **Validates: Requirement 11.1**

- [ ] 8. Checkpoint - Backend WebSocket Complete
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 9. Frontend Setup and Configuration
  - [ ] 9.1 Install frontend dependencies and configure routing
  ...
  - [ ] 9.2 Create TypeScript type definitions
...
- [ ] 10. Frontend Authentication Context and Hooks
  - [ ] 10.1 Create AuthContext for admin authentication state
  ...
  - [ ]\* 10.3 Write property test for authorization enforcement
    - **Property 8: Authorization Enforcement**
    - **Validates: Requirement 4.1**

- [ ] 11. Frontend Socket Hook and Context
  - [ ] 11.1 Create useSocket hook for WebSocket management
  ...
  - [ ] 11.2 Create SocketContext for shared socket state (optional)
    - Create `contexts/SocketContext.tsx` if socket needs to be shared across components
    - _Requirements: N/A (optional enhancement)_

- [ ] 12. Frontend Common Components
  - [ ] 12.1 Create LoadingSpinner and ErrorMessage components
...
- [ ] 16. Frontend Pages
  ...
  - [ ] 16.3 Create AdminDashboard page
  ...
  - [ ]\* 16.4 Write property test for unread count accuracy
    - **Property 9: Unread Count Accuracy**
    - **Validates: Requirements 4.2, 12.3**

  - [ ]\* 16.5 Write property test for bulk read status update
    - **Property 23: Bulk Read Status Update**
    - **Validates: Requirement 12.4**

- [ ] 17. Wire Up App Module and Main Entry
  - [ ] 17.1 Configure NestJS AppModule with all modules
  ...
  - [ ] 17.2 Configure React App with providers and routes
    - Wrap App with AuthProvider
    - Configure all routes in React Router
    - _Requirements: N/A (infrastructure)_

- [ ] 18. Database Seeding
  - [ ] 18.1 Create seed script for initial admin and test locations
...
- [ ] 19. Final Checkpoint - Full Integration
  ...
  - [ ]\* 19.1 Write property test for DTO validation enforcement
    - **Property 20: DTO Validation Enforcement**
    - **Validates: Requirement 10.1**

  - [ ]\* 19.2 Write property test for invalid payload error handling
